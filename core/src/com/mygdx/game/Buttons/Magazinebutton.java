...
public class Magazinebutton extends Actor {
    Sprite sprite=new Sprite(new Texture(Gdx.files.internal("packages.png")));
    final Launch game;

    public Magazinebutton(final Launch game){
        this.game=game;
...
game.setScreen(new Magazine(game));
