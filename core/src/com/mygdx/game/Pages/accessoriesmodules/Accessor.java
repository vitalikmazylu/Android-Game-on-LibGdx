...
public class Accessor {
    ...
    public Accessor(SpriteBatch betch,Stage stage,ControlBar tb,byte level,int capacity,float tablex,float tabley){
        this.betch=betch;
        this.stage=stage;
        this.tb=tb;
...
//stage.addActor(pay);
    ...
    public void getpage(byte a){
        ...
        switch (a) {
            case 1:/*1 Page*/
                photo1 = "accesoireitem/JBL T110.jpg";
                priceitem1 = 11;
                dropprice1 = 11;
            ...
            case 2:/*2 Page*/
                photo1 = "accesoireitem/Xiaomi Watch S1.jpg";
                priceitem1 = 160;
                dropprice1 = 160;
                optprice1 = priceitem1 * 75 / 100;
                factoryprice1 = priceitem1 * 50 / 100;
                ...
                photo2 = "accesoireitem/Alisa.jpg";
                priceitem2 = 1000;
                dropprice2 = 1000;
                optprice2 = priceitem2 * 75 / 100;
                factoryprice2 = priceitem2 * 50 / 100;

                photo3 = "accesoireitem/Powerbank DEnmen DP08.jpg";
                priceitem3 = 20;
                dropprice3 = 20;
                optprice3 = priceitem3 * 75 / 100;
                factoryprice3 = priceitem3 * 50 / 100;

                photo4 = "accesoireitem/Ergo BS-710.jpg";
                priceitem4 = 12;
                dropprice4 = 12;
                optprice4 = priceitem4 * 75 / 100;
                factoryprice4 = priceitem4 * 50 / 100;
            ...
            case 3:/*3 Page*/
                photo1 = "accesoireitem/Atrix Smart Watch b3.jpg";
                priceitem1 = 13;
                dropprice1 = 13;
                optprice1 = priceitem1 * 75 / 100;
                factoryprice1 = priceitem1 * 50 / 100;
                ...
                photo2 = "accesoireitem/JBL GO.jpg";
                priceitem2 = 30;
                dropprice2 = 30;
                optprice2 = priceitem2 * 75 / 100;
                factoryprice2 = priceitem2 * 50 / 100;

                photo3 = "accesoireitem/Marshall Major.jpg";
                priceitem3 = 150;
                dropprice3 = 150;
                optprice3 = priceitem3 * 75 / 100;
                factoryprice3 = priceitem3 * 50 / 100;

                photo4 = "accesoireitem/IPod touch 7gen.jpg";
                priceitem4 = 210;
                dropprice4 = 210;
                optprice4 = priceitem4 * 75 / 100;
                factoryprice4 = priceitem4 * 50 / 100;
            ...
            case 4:/*4 page*/
                photo1 = "accesoireitem/UBL Charge 3.jpg";
                priceitem1 = 10;
                dropprice1 = 10;
                optprice1 = priceitem1 * 75 / 100;
                factoryprice1 = priceitem1 * 50 / 100;
                ...
                photo2 = "accesoireitem/Power Bank Wozinsky .jpg";
                priceitem2 = 95;
                dropprice2 = 95;
                optprice2 = priceitem2 * 75 / 100;
                factoryprice2 = priceitem2 * 50 / 100;

                photo3 = "accesoireitem/Apple Watch Series 7.jpg";
                priceitem3 = 400;
                dropprice3 = 400;
                optprice3 = priceitem3 * 75 / 100;
                factoryprice3 = priceitem3 * 50 / 100;

                photo4 = "accesoireitem/2E Aplpha X.jpg";
                priceitem4 = 50;
                dropprice4 = 50;
                optprice4 = priceitem4 * 75 / 100;
                factoryprice4 = priceitem4 * 50 / 100;
            ...
            case 5:/*5 Page*/
                photo1 = "accesoireitem/ToTo Tps-02.jpg";
                priceitem1 =10;
                dropprice1=10;
                optprice1 = priceitem1 * 75 / 100;
                factoryprice1 = priceitem1 * 50 / 100;
                ...
                photo2 = "accesoireitem/Hoco j86A PB.jpg";
                priceitem2 = 200;
                dropprice2 = 200;
                optprice2 = priceitem2 * 75 / 100;
                factoryprice2 = priceitem2 * 50 / 100;

                photo3 = "accesoireitem/FiiO M11 Plus.jpg";
                priceitem3 = 1000;
                dropprice3 = 1000;
                optprice3 = priceitem3 * 75 / 100;
                factoryprice3 = priceitem3 * 50 / 100;
