package com.mygdx.game.Pages.smartphonehelper;
...
BitmapFont prfont;
   ...
   public Smartphone(SpriteBatch betch,Stage stage,ControlBar tb,byte level,int capacity,float tablex,float tabley){
      this.betch=betch;
this.stage=stage;
this.tb=tb;
